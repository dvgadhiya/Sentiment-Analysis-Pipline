...
def training_pipeline(data_path: str):
    ...
    logging.info("Model 1 : Masked accuracy: {}".format(masked_acc))
    logging.info("Model 1 : Sequence accuracy: {}".format(sequence_acc))
    logging.info("Model 2 : accuracy: {}".format(masked_acc))
